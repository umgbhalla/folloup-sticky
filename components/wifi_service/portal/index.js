(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();const Pt={mode:"absolute",position:"bottom",height:"6rem",strength:2,divCount:5,exponential:!1,opacity:1,curve:"linear",zIndex:2},ot={linear:t=>t,bezier:t=>t*t*(3-2*t),"ease-in":t=>t*t,"ease-out":t=>1-Math.pow(1-t,2),"ease-in-out":t=>t<.5?2*t*t:1-Math.pow(-2*t+2,2)/2};function Nt(t){switch(t){case"top":return"to top";case"left":return"to left";case"right":return"to right";default:return"to bottom"}}function Vt(){if(typeof CSS>"u"||typeof CSS.supports!="function")return!1;const t=CSS.supports("backdrop-filter","blur(1px)")||CSS.supports("-webkit-backdrop-filter","blur(1px)"),e=CSS.supports("mask-image","linear-gradient(to bottom, transparent, black)")||CSS.supports("-webkit-mask-image","linear-gradient(to bottom, transparent, black)");return t&&e}function Dt(t){const e={...Pt,...t},n=document.createElement("div"),i=document.createElement("div"),o=Nt(e.position),a=Vt(),l=e.position==="top"||e.position==="bottom";if(n.className="gradual-blur",e.className&&n.classList.add(e.className),a||(n.classList.add("gradual-blur--fallback"),n.style.background=`linear-gradient(${o}, transparent 0%, ${e.fallbackColor||"rgba(255, 255, 255, 0.95)"} 100%)`),n.style.position=e.mode,n.style.pointerEvents="none",n.style.zIndex=String(e.zIndex),n.style.opacity="0",n.style.borderRadius="inherit",l?(n.style.height=e.height,n.style.width=e.width||"100%",n.style[e.position]="0",e.mode==="fixed"?(n.style.left="50%",n.style.right="auto",n.style.transform="translateX(-50%)"):(n.style.left="0",n.style.right="0")):(n.style.width=e.width||e.height,n.style.height="100%",n.style.top="0",n.style.bottom="0",n.style[e.position]="0"),i.className="gradual-blur__inner",n.appendChild(i),a){const d=100/e.divCount,c=ot[e.curve]||ot.linear;for(let f=1;f<=e.divCount;f+=1){const p=document.createElement("div"),k=c(f/e.divCount);let S=0;e.exponential?S=Math.pow(2,k*4)*.0625*e.strength:S=.0625*(k*e.divCount+1)*e.strength;const v=Math.round((d*f-d)*10)/10,y=Math.round(d*f*10)/10,T=Math.round((d*f+d)*10)/10,E=Math.round((d*f+d*2)*10)/10;let s=`transparent ${v}%, black ${y}%`;T<=100&&(s+=`, black ${T}%`),E<=100&&(s+=`, transparent ${E}%`),p.className="gradual-blur__layer",p.style.maskImage=`linear-gradient(${o}, ${s})`,p.style.webkitMaskImage=`linear-gradient(${o}, ${s})`,p.style.backdropFilter=`blur(${S.toFixed(3)}rem)`,p.style.setProperty("-webkit-backdrop-filter",`blur(${S.toFixed(3)}rem)`),p.style.opacity=String(e.opacity),i.appendChild(p)}}return window.getComputedStyle(e.mount).position==="static"&&(e.mount.style.position="relative"),e.mount.appendChild(n),{element:n,setVisible(d){n.style.opacity=d?"1":"0"},destroy(){n.remove()}}}const Ht=`:host {
  display: inline-flex;
  align-items: center;
...
`;function at(t){return t==="submit"||t==="reset"?t:"button"}class re extends HTMLElement{static get observedAttributes(){return["disabled","aria-label","type"]}constructor(){super();const e=this.attachShadow({mode:"open",delegatesFocus:!0});e.append(pt.content.cloneNode(!0)),this.button=e.querySelector("button")}connectedCallback(){this.dataset.component=G,this.syncAttributes()}attributeChangedCallback(){this.syncAttributes()}get disabled(){return this.hasAttribute("disabled")}set disabled(e){this.toggleAttribute("disabled",e)}get type(){return at(this.getAttribute("type"))}set type(e){this.setAttribute("type",at(e))}focus(e){this.button.focus(e)}click(){this.button.click()}syncAttributes(){this.button.disabled=this.disabled,this.button.type=this.type,this.tabIndex=this.disabled?-1:0;const e=this.getAttribute("aria-label");e?this.button.setAttribute("aria-label",e):this.button.removeAttribute("aria-label")}}function se(){customElements.get(G)||customElements.define(G,re)}const ae='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m644-428-58-58q9-47-27-88t-93-32l-58-58q17-8 34.5-12t37.5-4q75 0 127.5 52.5T660-500q0 20-4 37.5T644-428Zm128 126-58-56q38-29 67.5-63.5T832-500q-50-101-143.5-160.5T480-720q-29 0-57 4t-55 12l-62-62q41-17 84-25.5t90-8.5q151 0 269 83.5T920-500q-23 59-60.5 109.5T772-302Zm20 246L624-222q-35 11-70.5 16.5T480-200q-151 0-269-83.5T40-500q21-53 53-98.5t73-81.5L56-792l56-56 736 736-56 56ZM222-624q-29 26-53 57t-41 67q50 101 143.5 160.5T480-280q20 0 39-2.5t39-5.5l-36-38q-11 3-21 4.5t-21 1.5q-75 0-127.5-52.5T300-500q0-11 1.5-21t4.5-21l-84-82Zm319 93Zm-151 75Z"/></svg>',le='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z"/></svg>',ce=`:host {
  display: block;
  width: 100%;
}
...
`,U="ui-input",bt=document.createElement("template");bt.innerHTML=`
  <style>${ce}</style>
  <div class="form-control">
    <label></label>
    <div class="form-control__input-wrapper">
...
`,W="ui-network-list",vt="networkList",J="network-list-label",yt=document.createElement("template");yt.innerHTML=`
  <style>${me}</style>
  <div class="networks">
...
`,j="ui-network-status",wt="actionBtn",Ct="settingsBtn",xt="wifiStatusLabel",St="wifiStatusIcon",Tt="wifiStatusNetwork",kt=document.createElement("template");kt.innerHTML=`
  <style>${ve}</style>
...
`;const Te='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-80 240-320l57-57 183 183 183-183 57 57L480-80ZM298-584l-58-56 240-240 240 240-58 56-182-182-182 182Z"/></svg>',ke=`:host {
  display: block;
  width: 100%;
}
...
`,Y="ui-select",At=document.createElement("template");At.innerHTML=`
  <style>${ke}</style>
  <div class="form-control">
    <label></label>
    <div class="form-control__input-wrapper">
...
`;function lt(t){return t==="success"||t==="info"||t==="warning"||t==="error"||t==="danger"?t:null}class Be extends HTMLElement{static get observedAttributes(){return["aria-label","message","status"]}constructor(){super();const e=this.attachShadow({mode:"open"});e.append(Et.content.cloneNode(!0)),this.dialog=e.querySelector("dialog"),this.messageElement=e.querySelector(".toast-dialog__message")}connectedCallback(){this.dataset.component=X,this.syncAttributes()}attributeChangedCallback(){this.syncAttributes()}get message(){return this.messageElement.textContent||""}set message(e){this.setAttribute("message",e)}get status(){return lt(this.getAttribute("status"))}set status(e){if(e){this.setAttribute("status",e);return}this.removeAttribute("status")}show(e,n){typeof e=="string"&&(this.message=e),n&&(this.status=n),this.dialog.open||this.dialog.show()}close(e){this.dialog.close(e)}syncAttributes(){const e=this.getAttribute("aria-label"),n=this.getAttribute("message")||"",i=lt(this.getAttribute("status"));e?this.dialog.setAttribute("aria-label",e):this.dialog.removeAttribute("aria-label"),this.messageElement.textContent=n,this.messageElement.id=this.id?`${this.id}Message`:"statusToastMessage",this.dialog.id=this.id||"statusToast",i?this.dialog.setAttribute("data-status",i):this.dialog.removeAttribute("data-status")}}function ze(){customElements.get(X)||customElements.define(X,Be)}const qe=`<svg width="260" height="93" viewBox="0 0 260 93" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,Oe='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m109-531-85-85q92-89 210-136.5T480-800q128 0 246 47.5T936-616l-85 85q-75-72-171-110.5T480-680q-104 0-200 38.5T109-531Zm169 169-84-84q59-55 132.5-84.5T480-560q80 0 153.5 29.5T766-446l-84 84q-42-38-93.5-58T480-440q-57 0-108.5 20T278-362Zm202 202q-33 0-56.5-23.5T400-240q0-33 23.5-56.5T480-320q33 0 56.5 23.5T560-240q0 33-23.5 56.5T480-160Z"/></svg>',Pe='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm240-120q33 0 56.5-23.5T560-360q0-33-23.5-56.5T480-440q-33 0-56.5 23.5T400-360q0 33 23.5 56.5T480-280ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z"/></svg>',Ne='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q96-98 220-149t260-51q137 0 261 51t219 149L480-120ZM361-353q25-18 55.5-28t63.5-10q33 0 63.5 10t55.5 28l245-245q-78-59-170.5-90.5T480-720q-101 0-193.5 31.5T116-598l245 245Z"/></svg>',Ve='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q96-98 220-149t260-51q137 0 261 51t219 149L480-120ZM299-415q38-28 84-43.5t97-15.5q51 0 97 15.5t84 43.5l183-183q-78-59-170.5-90.5T480-720q-101 0-193.5 31.5T116-598l183 183Z"/></svg>',De='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q96-98 220-149t260-51q137 0 261 51t219 149L480-120ZM232-482q53-38 116-59.5T480-563q69 0 132 21.5T728-482l116-116q-78-59-170.5-90.5T480-720q-101 0-193.5 31.5T116-598l116 116Z"/></svg>',He='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-600q95-97 219.5-148.5T480-800q136 0 260.5 51.5T960-600L480-120Z"/></svg>',$e='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120 0-601q93-93 215.5-146T480-800q142 0 264.5 53T960-601l-56 57q-81-81-190-128.5T480-720q-103 0-195 32.5T117-597l419 420-56 57Zm384-40L761-262q-18 11-38 16.5t-43 5.5q-68 0-114-46t-46-114q0-68 46-114t114-46q68 0 114 46t46 114q0 23-5.5 43T818-319l102 103-56 56ZM680-320q34 0 57-23t23-57q0-34-23-57t-57-23q-34 0-57 23t-23 57q0 34 23 57t57 23ZM480-177Z"/></svg>',Ke='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M280-240q-100 0-170-70T40-480q0-100 70-170t170-70q66 0 121 33t87 87h432v240h-80v120H600v-120H488q-32 54-87 87t-121 33Zm0-80q66 0 106-40.5t48-79.5h246v120h80v-120h80v-80H434q-8-39-48-79.5T280-640q-66 0-113 47t-47 113q0 66 47 113t113 47Zm0-80q33 0 56.5-23.5T360-480q0-33-23.5-56.5T280-560q-33 0-56.5 23.5T200-480q0 33 23.5 56.5T280-400Zm0-80Z"/></svg>',Fe='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>',Re='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>',Ze={"Content-Type":"application/json",Accept:"application/json"},Ge=2e3,Ue=8,We=2e3,Je=8,je=3e3,Ye=750,Xe=20,Qe="/api/settings",tn=`${Qe}/time`,en="/api/runtime/time";async function B(t,e){const n=await fetch(t,{cache:"no-store",...e,headers:{...Ze,...e?.headers||{}}}),i=n.headers.get("content-type")||"",o=await n.text();if(!i.includes("application/json"))throw new Error(`Unexpected response for ${t}. Make sure you are connected to the device AP and loading the portal from the ESP32.`);const a=JSON.parse(o);if(!n.ok||a.success!==!0)throw new Error(a.message||"Request failed.");return a}const nn=(t,e)=>B(t,e),on=(t,e)=>B(t,e),rn=(t,e)=>B(t,e),Lt=(t,e)=>B(t,e),sn=(t,e)=>B(t,e);function b(t){const e=document.getElementById(t);if(!e)throw new Error(`Required portal element "#${t}" was not found.`);return e}function an(){return{followupLogoEl:b("followupLogo"),wifiStatusCard:b("wifiStatusCard"),wifiSettingsSheet:b("wifiSettingsSheet"),wifiSettingsCloseBtn:b("wifiSettingsCloseBtn"),wifiSettingsNotification:b("wifiSettingsNotification"),networkList:b("networkList"),passwordInput:b("password"),scanBtn:b("scanBtn"),connectBtn:b("connectBtn"),geminiCard:b("geminiCard"),geminiApiKeyInput:b("geminiApiKeyInput"),geminiClearBtn:b("geminiClearBtn"),geminiSaveBtn:b("geminiSaveBtn"),timezoneLocationCard:b("timezoneLocationCard"),timezoneSelect:b("timezoneSelect"),manualTimeInput:b("manualTimeInput"),manualDateInput:b("manualDateInput"),timezoneLocationClearBtn:b("timezoneLocationClearBtn"),timezoneLocationSaveBtn:b("timezoneLocationSaveBtn")}}function _t(t){return(e,n="info")=>{t.setNotification(e,n)}}function ln(t){return(e,n="info")=>{if(!e){t.hidden=!0,t.textContent="",t.removeAttribute("data-status"),t.setAttribute("role","status"),t.setAttribute("aria-live","polite");return}t.hidden=!1,t.textContent=e,t.setAttribute("data-status",n),n==="error"||n==="danger"?(t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive")):n==="warning"?(t.setAttribute("role","alert"),t.setAttribute("aria-live","polite")):(t.setAttribute("role","status"),t.setAttribute("aria-live","polite"))}}function tt(t){t.classList.remove("error"),t.removeAttribute("invalid"),t.setAttribute("aria-invalid","false"),t.setCustomValidity?.("")}function et(t,e){t.classList.add("error"),t.setAttribute("invalid",""),t.setAttribute("aria-invalid","true"),t.setCustomValidity?.(e)}function cn(t,e){t.setAttribute("aria-checked",e?"true":"false")}function dn(t){return t.getAttribute("aria-checked")==="true"}function It(t,e){return t.includes("class=")?t.replace("<svg",`<svg class="${e}"`):t.replace("<svg",`<svg class="${e}"`)}function un(t,e,n){t.innerHTML=It(e,n)}function hn(t){return new Promise(e=>{setTimeout(e,t)})}function gn(){const t=document.documentElement.lang?.trim();return t||"en-US"}function fn(t){try{return new Intl.DateTimeFormat(gn(),{hour:"numeric",timeZone:t,timeZoneName:"longGeneric"}).formatToParts(new Date).find(i=>i.type==="timeZoneName")?.value?.trim()||""}catch(e){return console.warn(`Failed to format timezone label for "${t}".`,e),""}}function ct(t){return/^(GMT|UTC)(?:[+-]\d{1,2}(?::\d{2})?)?$/.test(t)}function mn(t){return(t.split("/").pop()||t).replace(/_/g," ")}function Mt(t){return t.split("/").map(e=>e.replace(/_/g," ")).join(" / ")}function pn(t){const e=t.map(o=>{const a=fn(o.name);return{cityLabel:mn(o.name),genericLabel:a,name:o.name}}),n=new Map(e.map(o=>[o.name,o])),i=new Map;return e.forEach(o=>{!o.genericLabel||ct(o.genericLabel)||i.set(o.genericLabel,(i.get(o.genericLabel)||0)+1)}),new Map(t.map(o=>{const a=n.get(o.name),l=o.description?.trim()||"";if(a?.genericLabel&&!ct(a.genericLabel)){const c=(i.get(a.genericLabel)||0)>1?`${a.genericLabel} (${a.cityLabel})`:a.genericLabel;return[o.name,c]}return l?[o.name,l]:[o.name,Mt(o.name)]}))}function bn(t,e){return e.get(t.name)||t.description?.trim()||Mt(t.name)}function vn(t){const e=t.value.trim();if(!e)return null;const n=/^(\d{2}):(\d{2})$/.exec(e);if(!n)return null;const i=Number.parseInt(n[1],10),o=Number.parseInt(n[2],10);return!Number.isFinite(i)||!Number.isFinite(o)||i<0||i>23||o<0||o>59?null:i*60+o}function O(t,e,n){t.hasKey=n?.has_key===!0,t.last4=typeof n?.last4=="string"?n.last4:"",e.value=t.hasKey?t.last4?`******${t.last4}`:"******":""}function dt(t,e,n){t.hasKey=!1,t.last4="",e.value="",n("")}async function ut(t,e,n,i,o,a,l){const d=e.value.trim();if(!d){n(`${l} is required.`,"warning");return}t.isBusy=!0,n(a,"info"),i();try{const c=await o(t.settingsApi,{method:"PATCH",body:JSON.stringify({api_key:d})});O(t,e,c.settings),n(c.message||`${l} stored.`,"success")}catch(c){console.error(`${l} save failed:`,c),n(c instanceof Error?c.message:`Failed to store ${l}.`,"error")}finally{t.isBusy=!1,i()}}async function ht(t,e,n,i,o,a,l){t.isBusy=!0,n(a,"info"),i();try{const d=await o(t.resetApi,{method:"POST"});O(t,e,d.settings),n(d.message||l,"success")}catch(d){console.error(`${l} failed:`,d),n(d instanceof Error?d.message:`Failed to clear ${l}.`,"error")}finally{t.isBusy=!1,i()}}function yn(t){const e={hasKey:!1,isBusy:!1,last4:"",resetApi:"/api/settings/gemini/reset",settingsApi:"/api/settings/gemini"},n={hasKey:!1,isBusy:!1,last4:"",resetApi:"/api/settings/openai/reset",settingsApi:"/api/settings/openai"};function i(v){const y=v?.routes;e.settingsApi=y?.settings||"/api/settings/gemini",e.resetApi=y?.reset||"/api/settings/gemini/reset"}function o(v){const y=v?.routes;n.settingsApi=y?.settings||"/api/settings/openai",n.resetApi=y?.reset||"/api/settings/openai/reset"}function a(v){O(e,t.geminiApiKeyInput,v)}function l(){dt(e,t.geminiApiKeyInput,t.notifyGemini)}function d(v){O(n,t.openAiApiKeyInput,v)}function c(){dt(n,t.openAiApiKeyInput,t.notifyOpenAi)}async function f(){if(!t.isGeminiModuleActive()||e.isBusy||e.hasKey)return;if(!t.geminiApiKeyInput.value.trim()){t.notifyGemini("OpenRouter API key is required.","warning");return}await ut(e,t.geminiApiKeyInput,t.notifyGemini,t.updateButtons,t.fetchGeminiModuleJson,"Saving OpenRouter API key...","OpenRouter API key")}async function p(){!t.isGeminiModuleActive()||e.isBusy||await ht(e,t.geminiApiKeyInput,t.notifyGemini,t.updateButtons,t.fetchGeminiModuleJson,"Clearing OpenRouter API key...","OpenRouter API key cleared.")}async function k(){if(!t.isOpenAiModuleActive()||n.isBusy||n.hasKey)return;if(!t.openAiApiKeyInput.value.trim()){t.notifyOpenAi("OpenAI API key is required.","warning");return}await ut(n,t.openAiApiKeyInput,t.notifyOpenAi,t.updateButtons,t.fetchOpenAiModuleJson,"Saving OpenAI API key...","OpenAI API key")}async function S(){!t.isOpenAiModuleActive()||n.isBusy||await ht(n,t.openAiApiKeyInput,t.notifyOpenAi,t.updateButtons,t.fetchOpenAiModuleJson,"Clearing OpenAI API key...","OpenAI API key cleared.")}return{applyGeminiSettings:a,applyOpenAiSettings:d,clearGeminiKey:p,clearGeminiSettings:l,clearOpenAiKey:S,clearOpenAiSettings:c,getGeminiHasKey:()=>e.hasKey,getOpenAiHasKey:()=>n.hasKey,isGeminiBusy:()=>e.isBusy,isOpenAiBusy:()=>n.isBusy,saveGeminiKey:f,saveOpenAiKey:k,updateGeminiRoutes:i,updateOpenAiRoutes:o}}function wn(t){let e=!1,n=!1,i=!1,o=!1;async function a(){return t.fetchTimezoneListJson("/api/timezone/list")}function l(s){const h=s.settings,m=s.runtime;t.setSwitchChecked(t.clockModeToggle,!!h?.enabled),t.timezoneSelect.value=h?.timezone_name||"",t.clearFieldError(t.timezoneSelect),t.manualDateInput.value=typeof m?.current_date=="string"?m.current_date:"",t.manualTimeInput.value=typeof m?.current_time=="string"?m.current_time:""}function d(s){s&&(typeof s.clock_enabled=="boolean"&&t.setSwitchChecked(t.clockModeToggle,s.clock_enabled),t.manualDateInput.value=typeof s.current_date=="string"?s.current_date:"",t.manualTimeInput.value=typeof s.current_time=="string"?s.current_time:"")}async function c(){t.timezoneSelect.innerHTML="";const s=document.createElement("option");s.value="",s.textContent="Select timezone",t.timezoneSelect.appendChild(s);try{const h=await a(),m=Array.isArray(h.timezones)?h.timezones:[],x=t.buildTimezoneLabelMap(m);m.map(C=>({value:C.name,label:t.formatTimezoneLabel(C,x)})).sort((C,A)=>C.label.localeCompare(A.label)).forEach(C=>{const A=document.createElement("option");A.value=C.value,A.textContent=C.label,t.timezoneSelect.appendChild(A)})}catch(h){console.error("Timezone list fetch failed:",h),t.notify(h instanceof Error?h.message:"Failed to load timezones.","error")}}async function f(){if(!(e||n||i)){e=!0,n=!0,i=!0,t.onStateChange();try{const s=await t.fetchTimeSettingsJson(t.timeSettingsApi);l(s)}catch(s){console.error("Time settings status failed:",s),t.notify(s instanceof Error?s.message:"Time settings status failed.","error")}finally{e=!1,n=!1,i=!1,t.onStateChange()}}}async function p(){if(!(i||o)){o=!0;try{for(let s=0;s<t.clockSyncPollAttempts;s++){const h=await t.fetchTimeRuntimeJson(t.timeRuntimeApi);if(d(h.runtime),h.runtime?.time_valid===!0&&typeof h.runtime.current_time=="string"&&h.runtime.current_time.length>0)return;s<t.clockSyncPollAttempts-1&&await new Promise(m=>{setTimeout(m,t.clockSyncPollIntervalMs)})}}catch(s){console.error("Clock refresh after WiFi connect failed:",s)}finally{o=!1}}}async function k(){if(!(document.hidden||e||n||i)&&t.isSwitchChecked(t.clockModeToggle))try{const s=await t.fetchTimeRuntimeJson(t.timeRuntimeApi);d(s.runtime)}catch(s){console.error("Time runtime status failed:",s)}}function S(){const s=t.timezoneSelect.value.trim(),h=t.manualDateInput.value.trim(),m=t.manualTimeInput.value.trim(),x=t.parseClockTimeInputValue(t.wakeupTimeInput),C=t.parseClockTimeInputValue(t.bedtimeTimeInput);return!!h!=!!m?(t.notify("Provide both current date and time for a manual clock set.","error"),null):{timezoneName:s,manualDate:h,manualTime:m,wakeupMinutes:x??void 0,bedtimeMinutes:C??void 0}}async function v(s,h){return t.fetchTimeSettingsJson(t.timeSettingsApi,{method:"PATCH",body:JSON.stringify({timezone_name:s.timezoneName,enabled:h,manual_date:s.manualDate,manual_time:s.manualTime})})}async function y(){if(i||e||n){t.notifyClockMode("Clock mode update already in progress.","warning");return}const s=t.isSwitchChecked(t.clockModeToggle),h=!s,m=t.timezoneSelect.value.trim();t.setSwitchChecked(t.clockModeToggle,h),i=!0,t.notifyClockMode(h?"Enabling clock mode...":"Disabling clock mode...","info"),t.onStateChange();try{const x=await t.fetchTimeSettingsJson(t.timeSettingsApi,{method:"PATCH",body:JSON.stringify({enabled:h,timezone_name:h&&m?m:void 0})});l(x),t.notifyClockMode(x.message||(h?"Clock mode enabled.":"Clock mode disabled."),"success")}catch(x){t.setSwitchChecked(t.clockModeToggle,s),console.error("Clock mode toggle failed:",x);const C=x instanceof Error?x.message:"Failed to update clock mode.",A=C==="timezone_name required to enable clock"?"Please set timezone first.":C;C==="timezone_name required to enable clock"&&(t.setFieldError(t.timezoneSelect,"Select a timezone."),t.timezoneSelect.focus({preventScroll:!0})),t.notifyClockMode(A,"error")}finally{i=!1,t.onStateChange()}}async function T(){if(e||n||i||t.isTalkingClockModuleBusy()){t.notify("Time configuration update already in progress.","warning");return}const s=S();if(s){if(!s.timezoneName){t.setFieldError(t.timezoneSelect,"Select a timezone."),t.notify("Select a timezone.","error"),t.timezoneSelect.focus({preventScroll:!0});return}if(t.clearFieldError(t.timezoneSelect),t.isTalkingClockModuleActive()&&(s.wakeupMinutes===void 0||s.bedtimeMinutes===void 0)){t.notify("Wakeup and bedtime times are required for the talking clock module.","error"),t.focusTalkingClockTimeInput();return}e=!0,n=!0,i=!0,t.onTalkingClockBusyChange(t.isTalkingClockModuleActive()),t.notify("Saving time configuration...","info"),t.onStateChange();try{const h=await v(s,t.isSwitchChecked(t.clockModeToggle));if(l(h),t.isTalkingClockModuleActive()){const m=await t.patchTalkingClockSettings({wakeup_minutes:s.wakeupMinutes,bedtime_minutes:s.bedtimeMinutes});t.applyTalkingClockModuleSettings(m.settings)}t.notify("Time configuration saved successfully.","success")}catch(h){console.error("Timezone/location save failed:",h),t.notify(h instanceof Error?h.message:"Failed to save time configuration.","error")}finally{e=!1,n=!1,i=!1,t.onTalkingClockBusyChange(!1),t.onStateChange()}}}async function E(){if(e||n||i){t.notify("Time configuration update already in progress.","warning");return}e=!0,n=!0,i=!0,t.notify("Clearing timezone/location...","info"),t.onStateChange();try{const s=await t.fetchTimeSettingsJson(t.timeSettingsApi,{method:"PATCH",body:JSON.stringify({enabled:!1,timezone_name:""})});l(s),t.notify("Timezone/location cleared successfully.","success")}catch(s){console.error("Timezone/location clear failed:",s),t.notify(s instanceof Error?s.message:"Failed to clear timezone/location.","error")}finally{e=!1,n=!1,i=!1,t.onStateChange()}}return{applyTimeRuntimeStatus:d,applyTimeSettingsStatus:l,clearTimezoneLocation:E,fetchTimeRuntimeStatus:k,fetchTimeSettingsStatus:f,isClockBusy:()=>i,isLocationBusy:()=>n,isTimezoneBusy:()=>e,populateTimezoneOptions:c,refreshClockStatusAfterWifiConnect:p,saveTimezoneLocation:T,toggleClockModeSetting:y}}function Cn(t,e){return t>=-50?e.fourBar:t>=-60?e.threeBar:t>=-70?e.twoBar:e.oneBar}function xn(t){let e=[],n="",i=!1,o="",a=!1,l=!1,d=!1,c=-1;function f(){t.wifiStatusCard.hidden=!1,t.wifiStatusCard.statusLabel=i?"Connected":"Disconnected",t.wifiStatusCard.network=i?o:""}function p(){const r=document.createElement("li");r.className="networks__list-empty-state",r.innerHTML=`${t.svgWithClass(t.wifiFindIcon,"wifi-find-icon")}<p>Scan for available networks</p>`,t.networkList.setEmptyState(r)}function k(){if(e.length===0){n="",c=-1;return}const r=e.findIndex(u=>u.ssid===n);if(r>=0){c=r;return}n="",c=-1}function S(){const r=t.networkList.getOptions();r.forEach((u,g)=>{u.setAttribute("aria-selected",String(n===e[g]?.ssid))}),c>=0&&c<r.length?t.networkList.setActiveDescendant(r[c].id):t.networkList.setActiveDescendant(null)}function v(){const r=e.find(u=>u.ssid===n);return r?!r.is_open:!0}function y(r){n=r,c=e.findIndex(u=>u.ssid===r),v()||t.clearFieldError(t.passwordInput),S(),t.onStateChange()}function T(){if(k(),t.networkList.clearItems(),e.length===0){p();return}e.forEach((r,u)=>{const g=document.createElement("li");g.className="networks__item",g.id=`network-option-${u}`,g.setAttribute("role","option"),g.setAttribute("tabindex","-1"),g.setAttribute("aria-selected",String(n===r.ssid));const P=document.createElement("span");P.className="networks__item-ssid",P.textContent=r.ssid;const I=document.createElement("div");if(I.className="networks__item-details",o===r.ssid&&i){const D=document.createElement("span");D.title="Currently connected",D.innerHTML=t.svgWithClass(t.checkIcon,"wifi-connected-icon"),I.appendChild(D)}const N=document.createElement("span");N.title=r.is_open?"Open":"Secured",r.is_open||(N.innerHTML=t.svgWithClass(t.securityIcon,"wifi-security-icon")),I.appendChild(N);const V=document.createElement("span");V.title=`Signal strength: ${r.signal_strength} (${r.rssi} dBm)`,V.innerHTML=t.svgWithClass(Cn(r.rssi,t.signalIcons),"wifi-signal-icon"),I.appendChild(V),g.append(P,I),g.addEventListener("click",()=>{c=u,y(r.ssid),t.networkList.focus({preventScroll:!0})}),t.networkList.appendItem(g)}),S()}function E(r){const u=i,g=o;i=r.connected===!0,o=typeof r.ssid=="string"?r.ssid:"",f(),(u!==i||g!==o)&&T(),t.onConnectionStateChange?.({wasConnected:u,previousNetwork:g,isCurrentlyConnected:i,connectedNetwork:o})}async function s(){if(!a){a=!0,t.notify("Scanning for networks...","info"),t.onStateChange();try{let r="Scanning for networks...";for(let u=0;u<t.scanPollAttempts;u++){const g=await t.fetchPortalJson("/api/scan");if(r=g.message||r,g.scan_in_progress===!0){if(t.notify(r,"info"),u<t.scanPollAttempts-1){await t.delayMs(t.scanPollIntervalMs);continue}}else{e=Array.isArray(g.networks)?g.networks:[],t.notify(r||"Scan complete.","success"),T();return}}throw new Error("Network scan timed out. Please try again.")}catch(r){console.error("Scan failed:",r),t.notify(r instanceof Error?r.message:"Scan failed. Please try again.","error"),e=[],T()}finally{a=!1,t.onStateChange()}}}async function h(){if(!l){l=!0,t.onStateChange();try{const r=await t.fetchPortalJson("/api/status");E(r),a||t.notify(r.message||"Status updated.",r.connected?"success":"info")}catch(r){console.error("Status check failed:",r),t.notify(r instanceof Error?r.message:"Status check failed.","error")}finally{l=!1,t.onStateChange()}}}async function m(){if(!(d||!n)){if(v()&&t.passwordInput.value.trim().length===0){t.setFieldError(t.passwordInput,"Please enter a WiFi password."),t.passwordInput.focus({preventScroll:!0});return}t.clearFieldError(t.passwordInput),d=!0,t.notify(`Connecting to ${n}...`,"info"),t.onStateChange();try{const r=await t.fetchPortalJson("/api/configure",{method:"POST",body:JSON.stringify({ssid:n,password:t.passwordInput.value})});t.notify(r.message||"Connection request sent.","info");for(let u=0;u<t.statusPollAttempts;u++){await t.delayMs(t.statusPollIntervalMs);const g=await t.fetchPortalJson("/api/status");if(E(g),g.connected){t.notify(g.message||"Connected.","success");break}}i||t.notify("Connection in progress...","info")}catch(r){console.error("Connection failed:",r),t.notify(r instanceof Error?r.message:"Connection failed.","error")}finally{d=!1,t.onStateChange()}}}async function x(){if(!(d||l||!i)){l=!0,t.notify("Disconnecting...","info"),t.onStateChange();try{const r=await t.fetchPortalJson("/api/disconnect",{method:"POST"}),u=i,g=o;i=!1,o="",f(),T(),t.notify(r.message||"Disconnected.","success"),t.onConnectionStateChange?.({wasConnected:u,previousNetwork:g,isCurrentlyConnected:i,connectedNetwork:o})}catch(r){console.error("Disconnect failed:",r),t.notify(r instanceof Error?r.message:"Disconnect failed.","error")}finally{l=!1,t.onStateChange()}}}function C(){if(it()){x();return}if(d||l){t.notify("WiFi status is busy. Please wait.","warning");return}if(!n){t.notify("Select a WiFi network first.","error"),t.networkList.focus({preventScroll:!0});return}if(v()&&t.passwordInput.value.trim().length===0){t.setFieldError(t.passwordInput,"Please enter a WiFi password."),t.notify("Please check if your password is correct.","error"),t.passwordInput.focus({preventScroll:!0});return}t.clearFieldError(t.passwordInput),m()}function A(){t.passwordInput.value?.trim().length&&t.clearFieldError(t.passwordInput),t.onStateChange()}function Ot(r){if(e.length!==0)switch(k(),r.key){case"Tab":break;case"ArrowDown":{r.preventDefault();const u=c<e.length-1?c+1:0;c=u,y(e[u].ssid),t.networkList.scrollOptionIntoView(u);break}case"ArrowUp":{r.preventDefault();const u=c>0?c-1:e.length-1;c=u,y(e[u].ssid),t.networkList.scrollOptionIntoView(u);break}case"Home":{r.preventDefault(),c=0,y(e[0].ssid),t.networkList.scrollOptionIntoView(0);break}case"End":{r.preventDefault();const u=e.length-1;c=u,y(e[u].ssid),t.networkList.scrollOptionIntoView(u);break}case"Enter":case" ":{r.preventDefault(),c>=0&&c<e.length&&y(e[c].ssid);break}}}function it(){return i&&o.length>0&&n===o}return{applyPortalStatus:E,checkStatus:h,connect:m,disconnect:x,getConnectedNetwork:()=>o,getSelectedNetwork:()=>n,handleConnectAction:C,handleListboxKeyDown:Ot,handlePasswordInput:A,isCheckingStatus:()=>l,isConnecting:()=>d,isCurrentlyConnected:()=>i,isScanning:()=>a,isSelectedConnected:it,renderNetworkList:T,requiresPassword:v,scanNetworks:s,updateWifiStatusCard:f}}function z(t,e){e().finally(()=>{!t.disabled&&t.offsetParent!==null&&setTimeout(()=>{!t.disabled&&t.offsetParent!==null&&t.focus()},0)})}function Sn(t){const{controllers:e,dom:n,helpers:i}=t;function o(){n.wifiSettingsSheet.openBottomSheet(),e.wifiController.scanNetworks()}n.scanBtn.addEventListener("click",()=>{e.wifiController.scanNetworks()}),n.connectBtn.addEventListener("click",()=>{e.wifiController.handleConnectAction()}),n.wifiStatusCard.addEventListener("action",()=>{if(e.wifiController.isCurrentlyConnected()){e.wifiController.disconnect();return}o()}),n.wifiStatusCard.addEventListener("settings",()=>{o()}),n.wifiSettingsCloseBtn.addEventListener("click",()=>{n.wifiSettingsSheet.closeBottomSheet()}),n.passwordInput.addEventListener("input",()=>{e.wifiController.handlePasswordInput()}),n.networkList.addEventListener("keydown",a=>{e.wifiController.handleListboxKeyDown(a)}),n.geminiSaveBtn.addEventListener("click",()=>{z(n.geminiSaveBtn,()=>e.geminiController.saveGeminiKey())}),n.geminiClearBtn.addEventListener("click",()=>{z(n.geminiClearBtn,()=>e.geminiController.clearGeminiKey())}),n.geminiApiKeyInput.addEventListener("input",i.updateUi),n.timezoneLocationSaveBtn.addEventListener("click",()=>{if(!n.timezoneSelect.value.trim()){i.setFieldError(n.timezoneSelect,"Select a timezone."),i.setTimezoneLocationNotification("Select a timezone.","error"),n.timezoneSelect.focus({preventScroll:!0});return}i.clearFieldError(n.timezoneSelect),z(n.timezoneLocationSaveBtn,()=>e.timeController.saveTimezoneLocation())}),n.timezoneLocationClearBtn.addEventListener("click",()=>{z(n.timezoneLocationClearBtn,()=>e.timeController.clearTimezoneLocation())}),n.timezoneSelect.addEventListener("change",()=>{n.timezoneSelect.value?.trim().length&&i.clearFieldError(n.timezoneSelect),i.updateUi()}),n.manualDateInput.addEventListener("input",i.updateUi),n.manualTimeInput.addEventListener("input",i.updateUi)}function Tn(t){const{controllers:e,dom:n}=t,i=e.wifiController.isScanning()||e.wifiController.isConnecting()||e.wifiController.isCheckingStatus(),o=e.wifiController.isSelectedConnected(),a=e.wifiController.getSelectedNetwork().trim(),l=a.length>0&&!o&&e.wifiController.requiresPassword(),d=o||a.length>0&&(!l||n.passwordInput.value.trim().length>0);n.scanBtn.disabled=i,n.connectBtn.disabled=i||!d,n.wifiStatusCard.actionDisabled=i,n.passwordInput.disabled=e.wifiController.isConnecting(),e.wifiController.isConnecting()?(n.connectBtn.textContent="Connecting...",n.wifiStatusCard.actionLabel="Connecting..."):o?(n.connectBtn.textContent="Disconnect",n.wifiStatusCard.actionLabel="Disconnect"):(n.connectBtn.textContent="Connect",n.wifiStatusCard.actionLabel=e.wifiController.isCurrentlyConnected()?"Disconnect":"Connect");const c=e.timeController.isTimezoneBusy()||e.timeController.isLocationBusy()||e.timeController.isClockBusy();n.timezoneSelect.disabled=c,n.manualDateInput.disabled=c,n.manualTimeInput.disabled=c,n.timezoneLocationSaveBtn.disabled=c||n.timezoneSelect.value.trim().length===0,n.timezoneLocationClearBtn.disabled=c||n.timezoneSelect.value.trim().length===0;const f=e.geminiController.isGeminiBusy(),p=e.geminiController.getGeminiHasKey();n.geminiApiKeyInput.readOnly=p||f,n.geminiApiKeyInput.disabled=f,n.geminiSaveBtn.disabled=f||p||n.geminiApiKeyInput.value.trim().length===0,n.geminiSaveBtn.hidden=p,n.geminiClearBtn.disabled=f||!p,n.geminiClearBtn.hidden=!p}Jt();Rt();Qt();se();fe();be();Ce();Ee();ze();let Q=null;const w=an(),Bt=ln(w.wifiSettingsNotification),kn=_t(w.geminiCard),zt=_t(w.timezoneLocationCard),qt=()=>document.createElement("input"),An=document.createElement("button"),En=qt(),Ln=qt(),_n=document.createElement("input");function L(){Tn({controllers:{geminiController:nt,timeController:_,wifiController:M},dom:w})}const nt=yn({fetchGeminiModuleJson:Lt,fetchOpenAiModuleJson:()=>Promise.resolve({}),geminiApiKeyInput:w.geminiApiKeyInput,isGeminiModuleActive:()=>!0,isOpenAiModuleActive:()=>!1,notifyGemini:kn,notifyOpenAi:()=>{},openAiApiKeyInput:_n,updateButtons:L}),_=wn({applyTalkingClockModuleSettings:()=>{},bedtimeTimeInput:Ln,clearFieldError:tt,clockModeToggle:An,clockSyncPollAttempts:Je,clockSyncPollIntervalMs:We,fetchTimeRuntimeJson:rn,fetchTimeSettingsJson:on,fetchTimezoneListJson:sn,focusTalkingClockTimeInput:()=>{},buildTimezoneLabelMap:pn,formatTimezoneLabel:bn,isSwitchChecked:dn,isTalkingClockModuleActive:()=>!1,isTalkingClockModuleBusy:()=>!1,manualDateInput:w.manualDateInput,manualTimeInput:w.manualTimeInput,notifyClockMode:()=>{},notify:zt,onStateChange:L,onTalkingClockBusyChange:()=>{},parseClockTimeInputValue:vn,patchTalkingClockSettings:()=>Promise.resolve({success:!0}),setFieldError:et,setSwitchChecked:cn,timeRuntimeApi:en,timeSettingsApi:tn,timezoneSelect:w.timezoneSelect,wakeupTimeInput:En}),M=xn({checkIcon:Fe,clearFieldError:tt,delayMs:hn,fetchPortalJson:nn,networkList:w.networkList,notify:Bt,onConnectionStateChange:({wasConnected:t,isCurrentlyConnected:e})=>{!t&&e&&_.refreshClockStatusAfterWifiConnect()},onStateChange:L,passwordInput:w.passwordInput,scanPollAttempts:Xe,scanPollIntervalMs:Ye,securityIcon:Pe,setFieldError:et,signalIcons:{oneBar:Ne,twoBar:Ve,threeBar:De,fourBar:He},statusPollAttempts:Ue,statusPollIntervalMs:Ge,svgWithClass:It,wifiFindIcon:$e,wifiStatusCard:w.wifiStatusCard});function q(){if(!Q)return;const t=document.documentElement,e=t.scrollHeight>window.innerHeight+1,n=window.scrollY+window.innerHeight>=t.scrollHeight-1;Q.setVisible(e&&!n)}function In(){un(w.followupLogoEl,qe,"followup-logo"),w.wifiStatusCard.iconSvg=Oe,w.geminiCard.iconSvg=Ke,w.timezoneLocationCard.iconSvg=Re,M.renderNetworkList(),document.body&&(Q=Dt({mount:document.body,mode:"fixed",position:"bottom",height:"6rem",width:"100vw",strength:1.8,divCount:5,curve:"bezier",exponential:!0,opacity:1,zIndex:20,className:"page-gradual-blur",fallbackColor:"var(--color-bg-selected)"}),q(),window.addEventListener("scroll",q,{passive:!0}),window.addEventListener("resize",q),typeof ResizeObserver<"u"&&new ResizeObserver(()=>{q()}).observe(document.body)),L(),M.updateWifiStatusCard(),Bt(""),Sn({controllers:{geminiController:nt,timeController:_,wifiController:M},dom:w,helpers:{clearFieldError:tt,setFieldError:et,setTimezoneLocationNotification:zt,updateUi:L}}),Mn(),window.setInterval(()=>{_.fetchTimeRuntimeStatus()},je)}async function Mn(){await Promise.allSettled([_.populateTimezoneOptions(),_.fetchTimeSettingsStatus(),M.checkStatus(),Bn()])}async function Bn(){try{const t=await Lt("/api/settings/gemini");nt.applyGeminiSettings(t.settings)}catch(t){console.error("Gemini settings status failed:",t)}finally{L()}}In();
